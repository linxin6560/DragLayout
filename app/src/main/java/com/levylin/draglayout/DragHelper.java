...
/**
 * 资讯图片详情拖动帮助类
 * Created by LinXin on 2017/4/21.
 */
public class DragHelper implements DragRelativeLayout.OnMDragListener {
    ...
    public DragHelper(Activity activity, IGetCurrentViewAdapter adapter, View containerLayout, View otherViewLayout) {
